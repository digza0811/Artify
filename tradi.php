...
<div class="ha1">
  <p><a href="home.php" style="color:#C70039;">Home /</a><a href="collection.php" style="color:#C70039;">Collection /</a> <a href="collection.php" style="color:#C70039;">Indian Paintings / </a> <a href="#" style="color:#C70039;">Traditional,Ethenic,Folk,Tribal Paintings</a> </p>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-4 col-md-4 col-12">
      <div class="card">
          <img class="card-img-top" src="imagess/tra1.jpg" alt="Card image">
              <div class="card-body">
                <center>
                  <h4 class="card-title">Radha-Krishna Dance</h4>
            ...
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                  <img class="card-img-top" src="imagess/tra2.jpg" alt="Card image">
                      <div class="card-body">
                        <center>
                          <h4 class="card-title">Warli Dance</h4>
            ...
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                  <img class="card-img-top" src="imagess/tra3.jpg" alt="Card image">
                      <div class="card-body">
                        <center>
                          <h4 class="card-title">Dandiya</h4>
