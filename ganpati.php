...
<div class="ha1">
  <p><a href="home.php" style="color:#C70039;">Home /</a><a href="collection.php" style="color:#C70039;">Collection /</a> <a href="collection.php" style="color:#C70039;">Religious,God,Goddess Paintings
 / </a> <a href="#" style="color:#C70039;">Ganesha Paintings</a> </p>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-4 col-md-4 col-12">
      <div class="card">
          <img class="card-img-top" src="imagess/ganapati1.jpg" alt="Card image">
              <div class="card-body">
                <center>
                  <h4 class="card-title">Ganesha</h4>
            ...
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                  <img class="card-img-top" src="imagess/ganapati3.jpg" alt="Card image">
                      <div class="card-body">
                        <center>
                          <h4 class="card-title">Ganesh Vandana</h4>
            ...
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                  <img class="card-img-top" src="imagess/ganapati2.jpg" alt="Card image">
                      <div class="card-body">
                        <center>
                          <h4 class="card-title">Lord ganesha</h4>
