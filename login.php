...
<body>
  ...
  <form method="post" action="login.php">
  	...
  	<p>
  		Not yet a member? <a href="register.php" style="color:#C70039;">Sign up</a>
  	</p>
  </form>
  ...
  <div class="foot">
    ...
    <ul class="fa-ul">
      ...
      <li><span class="fa-li"><i class="fas fa-angle-double-right"></i></span><a href="adminlogin.php" style="color:#FFFFFF;">Admin Login</a></li>
    </ul>
    </div>
  </div>
