...
<div class="ha1">
  <p><a href="home.php" style="color:#C70039;">Home /</a><a href="collection.php" style="color:#C70039;">Collection /</a> <a href="collection.php" style="color:#C70039;">Abstract Paintings / </a> <a href="#" style="color:#C70039;">Pure Abstarct Paintings</a> </p>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-4 col-md-4 col-12">
      <div class="card">
          <img class="card-img-top" src="imagess/pure3.jpg" alt="Card image">
              <div class="card-body">
                <center>
                  <h4 class="card-title">Mixture of colours</h4>
            ...
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                  <img class="card-img-top" src="imagess/pure2.jpg" alt="Card image">
                      <div class="card-body">
                        <center>
            ...
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                  <img class="card-img-top" src="imagess/pure1.jpg" alt="Card image">
                      <div class="card-body">
                        <center>
                          <h4 class="card-title">Abstract women Paintings</h4>
