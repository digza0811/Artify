...
<div class="ha1">
  <p><a href="home.php" style="color:#C70039;">Home /</a><a href="collection.php" style="color:#C70039;">Collection /</a> <a href="collection.php" style="color:#C70039;">Animals,Birds,Fishes Paintings / </a> <a href="#" style="color:#C70039;">Wild Life Paintings</a> </p>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-4 col-md-4 col-12">
      <div class="card">
          <img class="card-img-top" src="imagess/wild2.jpg" alt="Card image">
              <div class="card-body">
                <center>
            ...
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                  <img class="card-img-top" src="imagess/wild1.jpg" alt="Card image">
                      <div class="card-body">
                        <center>
                          <h4 class="card-title">Elephent</h4>
            ...
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                  <img class="card-img-top" src="imagess/wild3.jpg" alt="Card image">
                      <div class="card-body">
                        <center>
                          <h4 class="card-title">Best animal Painting</h4>
