...
<body>
  ...
  <form method="post" action="register.php">
  	...
  	<div class="input-group">
  	  <button type="submit" class="btn" name="reg_user" style="background-color: #C70039;">Register</button>
  	</div>
  	<p>
  		Already a member? <a href="login.php" style="color:#C70039;">Sign in</a>
  	</p>
  </form>
