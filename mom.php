...
<div class="ha1">
  <p><a href="home.php" style="color:#C70039;">Home /</a><a href="collection.php" style="color:#C70039;">Collection /</a> <a href="collection.php" style="color:#C70039;">Religious,God,Goddess Paintings / </a> <a href="#" style="color:#C70039;">Mother Mary,Jesus Christ Paintings </a> </p>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-4 col-md-4 col-12">
      <div class="card">
          <img class="card-img-top" src="imagess/jes1.jpg" alt="Card image">
              <div class="card-body">
                <center>
                  <h4 class="card-title">Jesus Christ Paintings</h4>
            ...
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                  <img class="card-img-top" src="imagess/jes3.jpg" alt="Card image">
                      <div class="card-body">
                        <center>
            ...
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                  <img class="card-img-top" src="imagess/jes2.jpg" alt="Card image">
                      <div class="card-body">
                        <center>
                          <h4 class="card-title">Jesus Christ-spiritual teacher</h4>
