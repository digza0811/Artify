    ...
    switch ($_GET['action']) {
        ...
        case 'add':
            if (!empty($_POST['quantity'])) {
                $pid = $_GET['pid'];
                $query = "SELECT * FROM product2 WHERE id=" . $pid;
...
<div class="container py-5">
    <div class="d-flex justify-content-between mb-2">
        <h3>Cart</h3>
        <a class="btn btn-danger" href="index2.php?action=empty">All Item Remove</a>
	<a class="btn btn-dange" href="bill.php">Check Out</a>
    </div>
    <div class="row">
        <?php
            $total_quantity = 0;
                ...
                foreach ($_SESSION['cart_item'] as $item) {
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="index2.php?action=remove&code=<?= $item['code']; ?>" class="btn btn-danger">X</a>
                        </td>
                    </tr>
                ...
                <div class="card-deck">
                    ...
                    if (!empty($product)) {
                        while ($row = mysqli_fetch_array($product)) { ?>
                            <form action="index2.php?action=add&pid=<?= $row['id']; ?>" method="post">
