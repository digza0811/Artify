...
<div class="ha1">
  <p><a href="home.php" style="color:#C70039;">Home /</a><a href="collection.php" style="color:#C70039;">Collection /</a> <a href="collection.php" style="color:#C70039;">Religious,God,Goddess Paintings / </a> <a href="#" style="color:#C70039;">Krishna,Radha-Krishna Paintings</a> </p>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-4 col-md-4 col-12">
      <div class="card">
          <img class="card-img-top" src="imagess/krishna2.jpg" alt="Card image">
              <div class="card-body">
                <center>
                  <h4 class="card-title">Lord Krishna</h4>
                  <p class="card-text">9.5in X 12.75in</p>
            ...
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                  <img class="card-img-top" src="imagess/krishna4.jpg" alt="Card image">
                      <div class="card-body">
                        <center>
                          <h4 class="card-title">Radha-krishna with flute</h4>
                          <p class="card-text">10.03in X 13.43in</p>
                          <a href="#" class="btn btn-danger">Add to cart</a>
                        </center>
                        </div>
                      </div>
            ...
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                  <img class="card-img-top" src="imagess/krishna3.jpg" alt="Card image">
                      <div class="card-body">
                        <center>
                          <h4 class="card-title">krishna with flute</h4>
                          <p class="card-text">14.16in X 17.9in</p>
                          <a href="#" class="btn btn-danger">Add to Cart</a>
                        </center>
                        </div>
                      </div>
